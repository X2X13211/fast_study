---
{"dg-publish":true,"permalink":"/selenium-python/chto-takoe-selenium-i-kak-on-rabotaet/","dg-note-properties":{}}
---
...
![](https://thumb.tildacdn.com/tild6461-3833-4436-b130-646239373264/-/format/webp/image.png)

Важно понимать, что **Selenium** - не является инструментом автоматизации тестирования, это инструмент для управления браузером.
[[selenium_python/Управление навигацией браузера\|Управление навигацией браузера]]